...
namespace SquirrelAdventures
{
    class TelaAjuda
    {
        ...
        public TelaAjuda(Texture2D telaAjuda, Texture2D botao, SpriteBatch render, TelaMenu menu)
        {
        ...
        public void draw(GameTime gameTime, SpriteBatch render)
        {
            ...
            render.Draw(telaAjuda, new Rectangle(0,0,800,600), Color.White);
